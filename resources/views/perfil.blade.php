...
<div id="opciones">
  ...
  <a href="nosotros" class="bar">Nosotros</a>
            ...
            <div id="cuponera" class="cuponera">
                ...
                <br>
                                <p1 class="text">Gestion de usuario Autorizar</p1>
...
<table border="1" class="table">
  ...
  <tr>                                <form action="" method = "POST" >
    ...
    <td> <input type="text" class="perfil" id="id" name="id" placeholder="Ingrese el ID"></td>
        <td> <input type="text" class="perfil" id="comision" name="comision" placeholder="comision"></td>
